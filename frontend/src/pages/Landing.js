    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="border-2 hover:border-blue-500 transition-all shadow-lg bg-white">
            <CardContent className="pt-6">
              ...
              <h3 className="text-xl font-bold mb-2 text-black">Workflow Automation</h3>
              <p className="text-gray-800 font-semibold">
          ...
          <Card className="border-2 hover:border-blue-500 transition-all shadow-lg bg-white">
            <CardContent className="pt-6">
              ...
              <h3 className="text-xl font-bold mb-2 text-black">Document & Finance Management</h3>
              <p className="text-gray-800 font-semibold">
      ...
      <footer className="border-t py-8 mt-20">
        <div className="max-w-7xl mx-auto px-4 text-center text-gray-600">
          <p className="text-gray-800 font-medium">© 2025 Agentik Solutions. Enterprise Business Intelligence Platform.</p>
        </div>
      </footer>
    </div>
  );
